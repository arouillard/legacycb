...
def encode_and_decode(dm, W, Be, Bd, activation, apply_activation_to_embedding=False, apply_activation_to_output=False, return_embedding=False, return_reconstruction_error=False, bn_encode_variables=None, bn_decode_variables=None):
    mat = dm.matrix.copy()
