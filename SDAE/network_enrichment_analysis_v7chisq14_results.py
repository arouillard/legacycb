...
dataset_info['pankaj_disease_genes'] = {'folder':'gtextissue', 'abbreviation':'pankaj_disease_genes', 'name':'Ranked Disease Genes from Pankaj', 'path':'C:/Users/ar988996/Documents/Harmonizome/datasets/gtextissue/gene_disease_matrix_pankaj.pickle'}
dataset_info['sarah_blood_genes'] = {'folder':'gtextissue', 'abbreviation':'sarah_blood_genes', 'name':'Blood Specific Genes from Sarah', 'path':'C:/Users/ar988996/Documents/Harmonizome/datasets/gtextissue/gene_cluster_matrix_sarah.pickle'}
...
for datasetabbrev, datasetinfo in dataset_info.items():
    ...
    if 'sarah' not in datasetabbrev: # datasetabbrev not in {'kegg', 'panther', 'reactome', 'wikipathways'}:
        continue
