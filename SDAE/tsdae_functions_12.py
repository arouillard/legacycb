            ...
            for epoch in range(d['current_epochs']):
                ...
                for batch in range(d['batches']):
                    ...
                    if training_step == reporting_steps[i]:
                        ...
                        valid_losses[i], valid_losses_normal[i], valid_losses_bernoulli[i] = sess.run([loss, normal_loss, bernoulli_loss], feed_dict={training:False, get_normal_to_bernoulli_error:False, selection_mask:is_valid, noise_prob:0, structured_noise_prob:0})
                        valid_noisy_losses[i], valid_noisy_losses_normal[i], valid_noisy_losses_bernoulli[i] = sess.run([loss, normal_loss, bernoulli_loss], feed_dict={training:False, get_normal_to_bernoulli_error:False, selection_mask:is_valid, noise_prob:d['noise_probability'], structured_noise_prob:d['structured_noise_probability']})
