...
input_path = 'data/prepared_data/fat'
output_path = 'results/autoencoder/fat/tuning/lsf{0!s}_md{1!s}_{2!s}_np{3!s}_ns{4!s}_is{5!s}_lr{6!s}_eps{7!s}_bf{8!s}_pte{9!s}_fte{10!s}_{11}'\
