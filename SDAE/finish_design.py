...
def main(design_dict_or_path):
    ...
    d['all_dimensions'] = sdae_design_functions.get_layer_dimensions(d['input_dimension'], d['min_dimension'], d['hidden_layers'], d['first_hidden_layer_scaling_factor'])
    ...
    for phase, phase_epochs in [('pretraining', d['pretraining_epochs']), ('finetuning', d['finetuning_epochs']), ('last_layer', d['last_layer_epochs'])]:
        ...
        reporting_steps = sdae_design_functions.create_reporting_steps(phase_steps, d['firstcheckpoint'], d['maxstepspercheckpoint'])
    ...
    d['training_schedule'] = sdae_design_functions.create_layer_training_schedule(d['hidden_layers'], d['pretraining_epochs'], d['finetuning_epochs'], d['last_layer_epochs'], d['use_finetuning'])
