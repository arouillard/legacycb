...
gene_cluster.matrix = gene_cluster.matrix < 0.05
...
#    if datasetabbrev not in {'kegg'}: #{'kegg', 'panther', 'reactome', 'wikipathways'}:
#        continue
...
#    gene_atb.rowmeta['class'][np.in1d(gene_atb.rowlabels, class_examples['negative'])] = 'negative'
    ...
    gene_atb.columnmeta['arbitrary_pvalues'][~gene_atb.columnmeta['isrowstat']] = feature_selection_test_function(X=gene_atb.matrix[:,~gene_atb.columnmeta['isrowstat']], Y=gene_cst.matrix[:,0])[1]
    gene_atb.columnmeta['arbitrary_pvalues'][gene_atb.columnmeta['isrowstat']] = featureselection.univariate_utest(X=gene_atb.matrix[:,gene_atb.columnmeta['isrowstat']], Y=gene_cst.matrix[:,0])[1]
