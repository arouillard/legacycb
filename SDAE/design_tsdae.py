...
import finish_tsdae_design as finish_design
...
#    design_paths_path = '/'.join(design_specs_path.split('/')[:-1] + ['design_paths.txt'])
    ...
    print('done design_tsdae.', flush=True)
    
    return design_paths, design_paths_path
    
    
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Create TSDAE designs according to design specifications.')
