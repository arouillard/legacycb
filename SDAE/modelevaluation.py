...
def get_priority_cutoff_metadata(stat_cut, pp_min_frac=0.1, xx_min_frac=0.01):
    ...
    stat_cut.columnmeta['tpr_cutoff'] = np.arange(stat_cut.shape[1], dtype='int64') == tpr_idx
