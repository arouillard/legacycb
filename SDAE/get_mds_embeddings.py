...
mds = MDS(n_components=2, metric=True, n_init=4, max_iter=1000, n_jobs=16, verbose=1, dissimilarity='precomputed').fit(D)
...
with open('results/alternative_embeddings/mds2d_eucdist.pickle', 'wb') as fw:
...
fg.savefig('results/alternative_embeddings/mds2d_eucdist.png', transparent=True, pad_inches=0, dpi=600)
plt.close()
...
ax.tick_params(axis='both', which='major', bottom='off', top='off', labelbottom='off', labeltop='off', left='off', right='off', labelleft='off', labelright='off', pad=4)
ax.set_frame_on(False)
fg.savefig('results/alternative_embeddings/mds2d_eucdist_coloredbytissueenrichment_ccle.png', transparent=True, pad_inches=0, dpi=600)
plt.close()
...
mds2d_valid = mds.embedding_[train_examples:train_examples+valid_examples,:]
mds2d_test = mds.embedding_[train_examples+valid_examples:,:]
with open('results/alternative_embeddings/mds2d_angcosdist.pickle', 'wb') as fw:
    pickle.dump((mds2d_train, mds2d_valid, mds2d_test), fw)
...
ax.tick_params(axis='both', which='major', bottom='off', top='off', labelbottom='off', labeltop='off', left='off', right='off', labelleft='off', labelright='off', pad=4)
ax.set_frame_on(False)
fg.savefig('results/alternative_embeddings/mds2d_angcosdist.png', transparent=True, pad_inches=0, dpi=600)
plt.close()
...
ax.tick_params(axis='both', which='major', bottom='off', top='off', labelbottom='off', labeltop='off', left='off', right='off', labelleft='off', labelright='off', pad=4)
ax.set_frame_on(False)
fg.savefig('results/alternative_embeddings/mds2d_angcosdist_coloredbytissueenrichment_ccle.png', transparent=True, pad_inches=0, dpi=600)
plt.close()
