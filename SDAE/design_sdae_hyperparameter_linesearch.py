...
def main(base_design_path):
    ...
    hyperparameter_values['noise_sigma'] = [2.5, 5.0, 7.5]
    ...
    for hyperparameter, values in hyperparameter_values.items():
        ...
        for value in values:
            print('        working on value {0!s}...'.format(value), flush=True)
    ...
    design_paths_path = base_design_path.replace('design.json', 'linesearch_design_paths.txt')
    ...
    print('done setup_sdae_hyperparameter_linesearch.', flush=True)
