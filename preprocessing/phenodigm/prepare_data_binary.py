...
datasetIO.save_datamatrix('../../original_data/phenodigm/gene_disease_phenodigm-qtq_trimmed_thresholded.pickle', gene_atb)
datasetIO.save_datamatrix('../../original_data/phenodigm/gene_disease_phenodigm-qtq_trimmed_thresholded.txt.gz', gene_atb)
...
datasetIO.save_datamatrix('../../original_data/phenodigm/gene_disease_phenodigm-qtq_trimmed_thresholded_prepared.pickle', gene_atb)
datasetIO.save_datamatrix('../../original_data/phenodigm/gene_disease_phenodigm-qtq_trimmed_thresholded_prepared.txt.gz', gene_atb)
savefolder = '../../input_data/phenodigm_binary'
os.makedirs(savefolder)
datasetIO.save_splitdata(savefolder, gene_atb)
shutil.copyfile('../../original_data/phenodigm/gene_disease_phenodigm-qtq_trimmed_thresholded_prepared.txt.gz', '{0}/datamatrix.txt.gz'.format(savefolder))
