...
# load the data
gene_atb = datasetIO.load_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl2_counts.pickle')
#gene_atb = datasetIO.load_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl2_scaledcounts.pickle')
...
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl2_scaledcounts.pickle', gene_atb)
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl2_scaledcounts.txt.gz', gene_atb)
...
detectionlimit = 1
fractionsamplesbelowdetection = ((gene_atb.matrix[:,gene_atb.columnmeta['is_core_sample']] < detectionlimit).sum(1))/(gene_atb.columnmeta['is_core_sample'].sum())
...
u_specific_tissues = np.unique(gene_atb.columnmeta['specific_tissue'][gene_atb.columnmeta['is_core_sample']])
...
for j, specific_tissue in enumerate(u_specific_tissues):
    specific_tissue_mins[:,j] = np.min(gene_atb.matrix[:,np.logical_and(gene_atb.columnmeta['specific_tissue'] == specific_tissue, gene_atb.columnmeta['is_core_sample'])], 1)
robustlimit = 10
...
median_sample = np.median(gene_atb.matrix[:,gene_atb.columnmeta['is_core_sample']], 1)
...
gene_tis.discard(~gene_tis.columnmeta['is_core_sample'], 1)
...
row_mean = gene_atb.matrix[:,gene_atb.columnmeta['is_core_sample']].mean(1, keepdims=True)
row_stdv = gene_atb.matrix[:,gene_atb.columnmeta['is_core_sample']].std(1, keepdims=True)
...
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl2_scaledcounts_prepared.pickle', gene_atb)
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl2_scaledcounts_prepared.txt.gz', gene_atb)
with open('../../original_data/GTEXv6plus/prepare_specs_and_transform_vars_for_tl2.pickle', 'wb') as fw:
...
savefolder = '../../input_data/GTEXv6plusTL2'
if not os.path.exists(savefolder):
    os.makedirs(savefolder)
datasetIO.save_splitdata(savefolder, gene_atb)
shutil.copyfile('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl2_scaledcounts_prepared.pickle', '{0}/datamatrix.pickle'.format(savefolder))
shutil.copyfile('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl2_scaledcounts_prepared.txt.gz', '{0}/datamatrix.txt.gz'.format(savefolder))
