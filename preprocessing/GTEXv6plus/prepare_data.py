...
# load the data
gene_atb = datasetIO.load_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_counts.pickle')
...
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_scaledcounts.pickle', gene_atb)
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_scaledcounts.txt.gz', gene_atb)
...
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_scaledcounts_prepared.pickle', gene_atb)
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_scaledcounts_prepared.txt.gz', gene_atb)
with open('../../original_data/GTEXv6plus/prepare_specs_and_transform_vars.pickle', 'wb') as fw:
...
savefolder = '../../input_data/GTEXv6plus'
os.makedirs(savefolder)
datasetIO.save_splitdata(savefolder, gene_atb)
shutil.copyfile('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_scaledcounts_prepared.txt.gz', '{0}/datamatrix.txt.gz'.format(savefolder))
