...
with open('../../original_data/GTEXv6plus/sampling_scheme_for_tl.txt', mode='rt', encoding='utf-8', errors='surrogateescape') as fr,\
     open('../../original_data/GTEXv6plus/candidate_samples_for_tl.txt', mode='wt', encoding='utf-8', errors='surrogateescape') as fw:
    fr.readline()
    for line in fr:
...
with open('../../original_data/GTEXv6plus/chosen_samples_for_tl.txt', mode='wt', encoding='utf-8', errors='surrogateescape') as fw:
    fw.write('\n'.join(chosen_samples))
'''
chosen_samples = np.empty(0, dtype='object')
with open('../../original_data/GTEXv6plus/sampling_scheme.txt', mode='rt', encoding='utf-8', errors='surrogateescape') as fr:
    ...
    for line in fr:
        ...
        if int(sample_selected) > 0:
            chosen_samples = np.append(chosen_samples, np.random.choice(candidate_samples, int(sample_selected), replace=False))
with open('../../original_data/GTEXv6plus/chosen_samples.txt', mode='rt', encoding='utf-8', errors='surrogateescape') as fr:
...
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl_counts.pickle', gene_tissue)
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl_counts.txt.gz', gene_tissue)
