...
with open('../../original_data/GTEXv6plus/sampling_scheme.txt', mode='rt', encoding='utf-8', errors='surrogateescape') as fr,\
     open('../../original_data/GTEXv6plus/candidate_samples.txt', mode='wt', encoding='utf-8', errors='surrogateescape') as fw:
    fr.readline()
    for line in fr:
...
with open('../../original_data/GTEXv6plus/chosen_samples.txt', mode='wt', encoding='utf-8', errors='surrogateescape') as fw:
    fw.write('\n'.join(chosen_samples))
'''
chosen_samples = np.empty(0, dtype='object')
with open('../../original_data/GTEXv6plus/sampling_scheme.txt', mode='rt', encoding='utf-8', errors='surrogateescape') as fr:
...
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_counts.pickle', gene_tissue)
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_counts.txt.gz', gene_tissue)
