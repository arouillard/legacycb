...
# load the data
#gene_atb = datasetIO.load_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl_counts.pickle')
gene_atb = datasetIO.load_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl_scaledcounts.pickle')
'''
# scale counts
...
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl_scaledcounts.pickle', gene_atb)
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl_scaledcounts.txt.gz', gene_atb)
'''
# shuffle the data
...
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl_scaledcounts_prepared.pickle', gene_atb)
datasetIO.save_datamatrix('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl_scaledcounts_prepared.txt.gz', gene_atb)
with open('../../original_data/GTEXv6plus/prepare_specs_and_transform_vars_for_tl.pickle', 'wb') as fw:
...
savefolder = '../../input_data/GTEXv6plusTL'
if not os.path.exists(savefolder):
    os.makedirs(savefolder)
datasetIO.save_splitdata(savefolder, gene_atb)
shutil.copyfile('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl_scaledcounts_prepared.pickle', '{0}/datamatrix.pickle'.format(savefolder))
shutil.copyfile('../../original_data/GTEXv6plus/gene_tissue_recount2gtexv6_chosen_samples_for_tl_scaledcounts_prepared.txt.gz', '{0}/datamatrix.txt.gz'.format(savefolder))
